					...
					<div class="form-area contact-form text-right" id="myForm" action="mail.php" method="post">
						<div class="row">
							<div class="col-lg-6 form-group" style="margin-left: 500px;">
								<input name="uname" placeholder="Enter Your Email Address" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Enter email address'" class="common-input mb-20 form-control" required="" type="email">

								<input name="password" placeholder="Enter Your Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Your Password'"
								 class="common-input mb-20 form-control" required="" type="text">
							</div>
							<div class="col-lg-6" style="margin-left: 310px;">
								<div class="alert-msg" style="text-align: left;"></div>
								<button class="primary-btn" style="float: right;">Login</button>
							</div>
						</div>
					</div>
	</div>
	<div class="col-lg-8" style="margin-top: 30px; margin-left: 570px; font-size: 20px;">
		<p>Don't Have An Account? &nbsp;<a href="facultysignup.jsp" target="_blank">Sign Up</a></p>
	</div>
	<!-- End Login Area -->
	</form>
	<!-- Start Footer Area -->
